...
//
// Code generated for Simulink model 'homework3_ros'.
//
// Model version                  : 1.30
// Simulink Coder version         : 24.1 (R2024a) 19-Nov-2023
// C/C++ source code generated on : Wed Oct 30 09:15:33 2024
//
  ...
  namespace matlab
  {
    ...
    void NodeInterface::initialize(int argc, char ** argv)
    {
      try {
        ...
        ROS_INFO("** Starting the model \"homework3_ros\" **\n");

        // initialize the model which will initialize the publishers and subscribers
        rtmSetErrorStatus(homework3_ros_M, (NULL));
        homework3_ros_initialize();
    ...
    boolean_T NodeInterface::getStopRequestedFlag(void)
    {
      ...
      return (!(rtmGetErrorStatus(homework3_ros_M)
                == (NULL)));

#else

      return (!(rtmGetErrorStatus(homework3_ros_M)
                == (NULL)) || rtmGetStopRequested(homework3_ros_M));
    ...
    {
      mRunModel = (rtmGetErrorStatus(homework3_ros_M) ==
                   (NULL));
      while (mRunModel) {
        mBaseRateSem.wait();
